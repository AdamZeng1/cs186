...
public  class DiskHashedRelation$ {
   ...
   */
  public  org.apache.spark.sql.execution.GeneralDiskHashedRelation apply (scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row> input, org.apache.spark.sql.catalyst.expressions.Projection keyGenerator, int size, int writeThreshold) { throw new RuntimeException(); }
}

...
public  class CachingIteratorGenerator {
   ...
   * @return
   */
  static public  scala.Function1<scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row>, scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row>> apply (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> cacheKeys, org.apache.spark.sql.catalyst.expressions.ScalaUdf udf, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> preUdfExpressions, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> postUdfExpressions, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> inputSchema) { throw new RuntimeException(); }
}

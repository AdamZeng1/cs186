...
// no position
public  class CS186Utils$ {
  /**
   * Static reference to the singleton instance of this Scala object.
   */
  public static final CS186Utils$ MODULE$ = null;
  public   CS186Utils$ () { throw new RuntimeException(); }
  /**
   ...
   * sequence of expressions then it returns null.
   * <p>
   * @param expressions
   * @return
   */

...
psql postgres -tAc "SELECT 1 FROM pg_roles WHERE rolname='ivolnov'" | grep -q 1 || createuser -d ivolnov;
createdb -U ivolnov -O ivolnov fec
psql -d fec -U ivolnov < schema.sql
